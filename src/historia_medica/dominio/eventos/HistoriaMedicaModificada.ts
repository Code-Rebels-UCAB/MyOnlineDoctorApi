...
export class HistoriaMedicaModificada extends EventoDominio{
    
    constructor (
        private readonly id_historia: string,
        private readonly id_paciente: string,
        private readonly id_registro: string,
        readonly Fecha: Date
    ){
        super();
        this.Nombre = 'HistoriaMedicaModificada';
        this.Fecha = Fecha 
    }
    ...
    GetInformacion(): {} { 
        return {
            ...
            id_registro_medico: this.id_registro, 
        }
    } 
}